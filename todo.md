...
GNN with social edges: (it's just with a portion of social edges-200k user transactions, run for all)
$$$$$$ gnn $$$$$$
...
TODO: For MF models we should fed the original edge_index without social_edges, and original node ids -> need refactor